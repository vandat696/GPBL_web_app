...
urlpatterns=[
  ...
  path("comment/like/add/<uuid:id>",views.comment_like_add , name="comment_like_add"),
  path("comment/dislike/add/<uuid:id>",views.comment_dislike_add , name="comment_dislike_add"),
